...
<form action="<c:url value='/admin/video/update'></c:url>" method="post"
	...
	<textarea id="description" name="description" rows="5" cols="50"
		placeholder="Enter your description here...">${video.description}</textarea>
	...
	<img id="imagess" height="150" width="200" src="${imgUrl}"
		alt="Current Image" /> <input type="file" onchange="chooseFile(this)"
	...
	<input type="radio" id="ston" name="status" value="1"
		...
		value="0" ${video.active == 0 ? 'checked' : ''}> <label
		for="stoff">Khóa</label><br> <input type="submit" value="Update">
</form>
<hr>